...
function handleWindowResize() {
    ...
    fullpage.style.width = videoChatDiv.clientWidth + "px";
    fullpage.style.height = videoChatDiv.clientHeight + "px";
    ...
    applyReshape(fullpage, videoChatDiv.clientWidth, videoChatDiv.clientHeight);
}
...
function killActiveBox() {
    ...
    var easyrtcid = easyrtc.getIthCaller(0);
    setTimeout(function () {
        easyrtc.hangup(easyrtcid);
    }, 400);
    setTimeout(function () {
        easyrtc.leaveRoom("default", null, null);
        easyrtc.disconnect();
        easyrtc.closeLocalMediaStream("default");
    }, 400);
...
function appInit(roomName) {
    ...
    easyrtc.easyApp(roomName, "box0", ["box1"], loginSuccess);
    easyrtc.setIceUsedInCalls(getModifiedIceList());
    easyrtc.setPeerListener(messageListener);

    document.getElementById('box0').style.display = 'inline-block';
    document.getElementById('i0').style.display = 'none';
    document.getElementById('span0').style.display = 'none';
    easyrtc.setDisconnectListener(function () {
        //layer.msg("LOST-CONNECTION" + "Lost connection to signaling server");
        //killActiveBox();
        //closevideoDiv();
    ...
    easyrtc.setOnCall(function (easyrtcid, slot) {
        ...
        if (slot === 0) {
            ...
            //document.getElementById('closeVideo').disabled = "";
        }
        handleWindowResize();
    });

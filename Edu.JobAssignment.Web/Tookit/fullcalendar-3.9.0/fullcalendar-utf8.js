/// <reference path="D:\MyVisualStudioWorkspace\EduProduct\IM\程序\EduIM1.0\Edu.Web\Views/Main/_WorkChatGroupList.cshtml" />
/*!
 * FullCalendar v3.9.0
...
var EventRenderer = /** @class */ (function () {
    ...
    EventRenderer.prototype.sortEventSegs = function (segs) {
        //如果是当天的，则去掉排序，按照数据的排序
        segs.sort(util_1.proxy(this, 'compareEventSegs'));
    };
    // A cmp function for determining which segments should take visual priority
    EventRenderer.prototype.compareEventSegs = function (seg1, seg2) {
        //如果是时间视图，那么不排序
        if (seg1.el[0].className.indexOf("20181019add") > 0) return;
...
var DayGrid = /** @class */ (function (_super) {
        ...
        var emptyCellsUntil = function (endCol) {
            while (col < endCol) {
                ...
                if (segsBelow.length) {
                    ...
                    td.addClass("fc-more-cell-selfs");
                    td.append(moreWrap);
    ...
    DayGrid.prototype.renderMoreLink = function (row, col, hiddenSegs) {
        ...
        var _this = this;
        var view = this.view;
        return $('<a class="fc-more fc-more-as"/>')
    ...
    DayGrid.prototype.showSegPopover = function (row, col, moreLink, segs) {
        ...
        if (this.isRTL) {
            ...
            //options.left = moreWrap.offset().left - topEl.offset().left - moreWrap.width() - 2+100;
            //options.left = moreWrap.offset().left - 71; // -1 to be over cell border
            //alert(options.left);
        }
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        //自己添加了一行
        title = title.substring(title.indexOf("月")+1, title.indexOf("日"));
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        classes.unshift('fc-time-grid-event', 'fc-v-event','fc-v-event-20181019add');
        ...
        return '<a title ="' + util_1.htmlEscape(eventDef.title) + '"class="' + classes.join(' ') + '"' +
            (eventDef.url ?
    ...
    TimeGridEventRenderer.prototype.generateFgSegHorizontalCss = function (seg) {
        ...
        //props.left = left * 100 + '%';
        props.left = left * 100 * 0 + '%';
        props.right = right * 100 * 0 + '%';
        ...
        for (i = 0; i < levelCnt; i++) {
            ...
            if (levelSegs) {
                for (j = 0; j < levelSegs.length; j++) {
                    ...
                    //自己修改的添加了一个新类
                    td = $('<td class="fc-event-container height40"/>').append(seg.el);
